...
public class WhileDivApp {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Please insert two integers for divition (numerator 0 for exit)");
